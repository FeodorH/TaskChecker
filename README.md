...
Проект построен на классической трёхуровневой архитектуре Controller → Service → Repository с использованием DTO и маппера для разделения API-контрактов и 
